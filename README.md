...
**55 тестов в шести файлах.** Доменные идут в среде `node` — логика не должна
...
- Worklog открывается, содержит навигацию и честные незаполненные поля;
...
Playwright в локальном приложении, отдельное открытие живой ссылки и тесты;
ручного прохода человеком
